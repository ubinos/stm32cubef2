...
if(STM32CUBEF2__USE_HAL_DRIVER)
    ...
    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/STM32Cube_FW_F2/Drivers/STM32F2xx_HAL_Driver/Src/stm32f2xx_hal_pwr.c)
    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/STM32Cube_FW_F2/Drivers/STM32F2xx_HAL_Driver/Src/stm32f2xx_hal_pwr_ex.c)
    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/STM32Cube_FW_F2/Drivers/STM32F2xx_HAL_Driver/Src/stm32f2xx_hal_rcc.c)
    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/STM32Cube_FW_F2/Drivers/STM32F2xx_HAL_Driver/Src/stm32f2xx_hal_rcc_ex.c)
...
if(STM32CUBEF2__USE_FULL_LL_DRIVER)
    ...
    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/STM32Cube_FW_F2/Drivers/STM32F2xx_HAL_Driver/Src/stm32f2xx_ll_rcc.c)
    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/STM32Cube_FW_F2/Drivers/STM32F2xx_HAL_Driver/Src/stm32f2xx_ll_utils.c)
