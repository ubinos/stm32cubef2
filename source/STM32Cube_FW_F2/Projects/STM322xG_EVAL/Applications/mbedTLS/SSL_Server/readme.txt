...
Scenario 2:
  - the client is a second board (STM322xG_EVAL), running the "SSL_Client" application.
...
@par Directory contents
    ...
    - mbedTLS/SSL_Server/Inc/stm32f2xx_it.h                 Interrupt handlers header file
    - mbedTLS/SSL_Server/Inc/stm32f2xx_hal_conf.h           Library Configuration file
    ...
    - mbedTLS/SSL_Server/Src/system_stm32f2xx.c             STM32 system clock configuration file
    - mbedTLS/SSL_Server/Src/net_sockets.c                  the TCP/IP socket API implemented over the LwIP stack.

@note Because of the low RAM size on the STM32F2 family the mbedtls_config.h is not the full-featured configuration.It is instead based on the configuration provided by the "config-suite-b.h" under mbedTLS-2.4.0/configs.
...
@par Hardware and Software environment
  ...
  - This application has been tested with two scenarios.
     ...
     - using two STM322xG_EVAL boards the first as server, the second as client.
